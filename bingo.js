...
const safeGods = ["Pharasma", "Asmodeus", "Cayden", "Urgathoa", "Erastil", "Nethys", "Zon-Kuthon", "Desna", "Irori", "Rovagug"];
const rawWidth = 1301;
...
function generateAltText(gods, pickedGod, safeGods, stamp) {
  ...
  + ` ${safeGods[0]}, ${safeGods[1]}, ${safeGods[2]}, ${safeGods[3]}, ${safeGods[4]}, ${safeGods[5]}, ${safeGods[6]}, ${safeGods[7]}, ${safeGods[8]}, and ${safeGods[9]} are already marked safe with a circle.`
